...
export type { Props as ProjectCardProps };
      ...
      <div className="p-6 flex flex-col gap-3 flex-1">
        <div className="flex items-start justify-between gap-2">
          <div className="flex flex-col gap-2">
            ...
            <h4 className="flex items-center gap-1 text-xs text-muted-foreground">
              <IconUsers className="inline-block size-3.5 mr-1" aria-hidden />
              {contributors ? contributors.join(", ") : "Solo Project"}
            </h4>
          </div>
          <Link
            href={href || "#"}
