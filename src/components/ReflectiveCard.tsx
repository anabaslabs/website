...
const ReflectiveCard: React.FC<ReflectiveCardProps> = ({
  ...
  return (
    <div
      className={`relative w-[320px] h-125 rounded-4xl overflow-hidden bg-[#1a1a1a] shadow-[0_20px_50px_rgba(0,0,0,0.5),0_0_0_1px_rgba(255,255,255,0.1)_inset] isolate font-sans ${className}`}
    ...
    >
      ...
      <div className="absolute inset-0 rounded-4xl p-px bg-[linear-gradient(135deg,rgba(255,255,255,0.8)_0%,rgba(255,255,255,0.2)_50%,rgba(255,255,255,0.6)_100%)] [mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] mask-exclude z-20 pointer-events-none" />

      <div className="relative z-10 h-full flex flex-col justify-between p-8 text-(--text-color,white) bg-(--overlay-color,rgba(255,255,255,0.05))">
